...
Contains solutions to the standad Dynamic Programming problems
"""
...
# print(subset_sum_dp([3, 34, 4, 12, 5, 2], 30, 6))
...
'''
target_sum = (sum_ + diff) // 2
print(subset_given_diff(arr, 4, target_sum))
...
'''
This ques is basically the number of subsets with given difference
'''
arr = [1,1,1,1,1]
x = 3
...
# print(unbounded_knapsack([5,10,15], [10, 30, 20], 100, 3))
...
coins = [1, 2, 3]
s = 5
# print(coin_change(coins, s, len(coins)))
...
print(lcsubs("zxabcdezy", "yzabcdezx", 9, 9))
# print(res)
...
print("Longest"lcsubs_memo("ABCDGH", "ACDGHR", 6, 6))
...
# print(print_lcs("AGGTAB", "GXTXAYB"))
...
# print(shortest_supersequence("geek", "eke"))
...
# print(shortest_supersequence_recusive("geek", "eke", 4, 3))
...
# print(longest_palindromic_subsq("bbbdb", 0, 4))
...
# print(longest_palindromic_subsq_dp("bbbdb"))
...
# print(min_del_inserts("leetcode"))
